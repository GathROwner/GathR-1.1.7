...
interface GathRShimmerPillProps {
  disabled?: boolean;
...
/**
 * GathR's reusable gold action treatment. It keeps the action legible when
 * Reduce Motion is enabled and otherwise adds the same restrained white sweep
 * used by ticket CTAs.
 */
const GathRShimmerPill: React.FC<GathRShimmerPillProps> = ({
  disabled = false,
  iconName,
  iconSize = 14,
  label,
...
export default GathRShimmerPill;
