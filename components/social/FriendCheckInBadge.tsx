  ...
  return (
    <View style={[styles.wrapper, style]} accessibilityLabel={`${count} ${count === 1 ? 'friend' : 'friends'} checked in`}>
      <View style={[styles.capsule, standalone && styles.standalone]}>
        <Ionicons name="people" size={standalone ? 16 : 12} color="#FFFFFF" />
...
const styles = StyleSheet.create({
  ...
  capsule: { minWidth: 30, height: 22, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 3, paddingHorizontal: 5, borderRadius: 12, borderWidth: 1.5, borderColor: '#FFFFFF', backgroundColor: '#6941C6', shadowColor: '#301A58', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 3, elevation: 5 },
  standalone: { minWidth: 42, height: 30, borderRadius: 16, borderWidth: 2, paddingHorizontal: 7 },
  count: { color: '#FFFFFF', fontSize: 10, fontWeight: '900' },
